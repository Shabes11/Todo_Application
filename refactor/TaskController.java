...
public class TaskController {
    ...
    public TaskController(Userinput userinput, Filehandler filehandler) {
    ...
    public TaskController() {
        this(new UserInput(), new Filehandler());
    }
    ...
    editTask(String title)
        if (tasks.exists(title)):
            Task task = tasks.getTask(title)
                return true 
